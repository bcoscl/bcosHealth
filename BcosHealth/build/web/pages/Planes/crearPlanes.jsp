    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" method="post" id="formCrearPlanes">              
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="text-input">Maximo de usuarios</label>
                    <div class="col-md-9">
                        <input class="form-control input_user" id="userMax" type="number"  value=""  name="text-input" placeholder="Cantidad maxima de profesionales" required>
                    </div>
                </div>
