...
public class security implements Filter {
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            //Log.debug(Thread.currentThread().getStackTrace()[1].getMethodName());
            if (debug) {
                System.out.println("security::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            //Log.debug(Thread.currentThread().getStackTrace()[1].getMethodName());
            if (debug) {
                System.out.println("security::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            //Log.debug(Thread.currentThread().getStackTrace()[1].getMethodName());
            if (debug) {
                System.out.println("security::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            //Log.debug(Thread.currentThread().getStackTrace()[1].getMethodName());
            if (debug) {
                System.out.println("security::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            //Log.debug(Thread.currentThread().getStackTrace()[1].getMethodName());
            if (debug) {
                System.out.println("security::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
