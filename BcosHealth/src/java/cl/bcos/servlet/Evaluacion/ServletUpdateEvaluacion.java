 ...
 * @author aacantero
 */
public class ServletUpdateEvaluacion extends HttpServlet {

    private static final Logger Log = Logger.getLogger(ServletUpdateEvaluacion.class);
...
//                https = "http://";
//            }
            String URL = ConstantsPath.CONTEXT + "/bcos/api/json/updateEvaluacion";
            Log.info(" URL :" + URL);
//            try {
            Map<String, String> parameter = new HashMap<String, String>();

            parameter.put("accion", accion);
            parameter.put("eva_id", row);
