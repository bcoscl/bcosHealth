 ...
 * @author aacantero
 */
public class ServletUpdateUsuarios extends HttpServlet {

    private static final Logger Log = Logger.getLogger(ServletUpdateUsuarios.class);
...
//                https = "http://";
//        }
            String URL = ConstantsPath.CONTEXT + "/bcos/api/json/updateUsuarios";
            Log.info(" URL :" + URL);
//            try {
            ...
            if (accion.equalsIgnoreCase("LU-DESACTIVAR")) {
                estado = "false";
                accion = "ESTADO";
            }
