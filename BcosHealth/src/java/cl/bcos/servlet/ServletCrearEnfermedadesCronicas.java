 ...
 * @author aacantero
 */
public class ServletCrearEnfermedadesCronicas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Log.info("cronica_name :" + cronica_name);
            Log.info("cronica_obs :" + cronica_obs);

            Log.info("token bearer:" + token);

            if(PATH.contains("localhost")){https = "http://";}String URL = https+PATH+ "/bcos/api/json/crearEnfermedadesCronicas";
//            try {
