...
public class ServletUploadArchivo extends HttpServlet {

    private static final Logger Log = Logger.getLogger(ServletUploadArchivo.class);
//    private static final String ENDPOINT_PATH = "URLPATH";
//    private static final String PATH = "api.health.bcos.cl";
...
//    private static String https = "https://";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String id = (String) request.getParameter("input_userid");
...
//                }
                ...
                String URL2 = ConstantsPath.CONTEXT + "/bcos/api/json/S3";
                Log.info(" URL :" + URL2);
                ...
                if (!"".equals(s3.getS3().getFOLDER_NAME_PROFILE())) {
                    fileName = s3.getS3().getFOLDER_NAME_PROFILE().toLowerCase() + "/" + fileName;
                }
...
//                        https = "http://";
//                    }
                    String URL = ConstantsPath.CONTEXT + "/bcos/api/json/updateImgProfile";
//            try {
                    ...
                    parameter2.put("imgName", fileName);
