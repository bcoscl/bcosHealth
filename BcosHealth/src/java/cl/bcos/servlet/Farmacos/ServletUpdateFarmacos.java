 ...
 */
package cl.bcos.servlet.Farmacos;
 ...
 * @author aacantero
 */
public class ServletUpdateFarmacos extends HttpServlet {

    private static final Logger Log = Logger.getLogger(ServletUpdateFarmacos.class);
...
//    private static String https = "https://";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String farmacoRowId = (String) request.getParameter("row");
...
//                https = "http://";
//            }
            String URL = ConstantsPath.CONTEXT + "/bcos/api/json/updateFarmacos";
            Log.info(" URL :" + URL);
//            try {
