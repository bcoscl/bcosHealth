...
<!DOCTYPE html>
<link href="../../pages/Fichas/css/listarFichas.css" rel="stylesheet">  

<div class="row">
    <div class="col">
        <ul class="nav nav-pills mb-1" id="pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active show" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Fichas</a>
            </li>
            <li class="nav-item">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 center">
                                        <span class="profile-picture">
                                            <img class="editable img-responsive" alt=" Avatar" id="avatar2" src="../Consultas/img/ProfilePerson.jpg">
                                        </span>
