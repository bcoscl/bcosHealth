                        ...
                        <div class="profile-user-info">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value">
                                    <input class="form-control" id="modal_input_examenes_nombre" type="text" name="text-input" placeholder="Nombre Examen">
                                </div>
                            </div>
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value" >
                                    <input class="form-control" id="modal_input_examenes_observacion" type="text" name="text-input" placeholder="Observación del Examen">
                                </div>
                            </div>
                            <div class="profile-info-row">
