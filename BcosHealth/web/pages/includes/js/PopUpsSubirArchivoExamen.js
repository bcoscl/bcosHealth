...
$(document).ready(function () {
    ...
    $("#fileuploadArchivo_examen").click(function () {
        $("#upload-file_examen").click();
    });

    $("#formArchivoPopUp_examen").submit(function (event) {
        //salert("Handler for .submit() called.");

//        var id = ($(this).parent().parent().find("form")).attr("id");
        

        if ($("#upload-file_examen").val()!="") {
...
function popupAddfileExamen() {

    //$('#input_userid').val($('#input_id').val());
    $('#largeModalsubirArchivosExamen').modal('toggle');
